...
public final class CheckerConfig {
     ...
     */
    private final List<String> inputRoots;
    /**
     ...
     */
    private final long missingOffsetsLimit;
    /**
     ...
     */
    private final Optional<SideTopicConfig> sideTopicConfig;
}
