...
PARQUET_GENERATOR="$WORKSPACE_ROOT/tests/fixtures/generate_kafka_offset_gap_fixtures.scala"
SIDE_TOPIC_GENERATOR="$WORKSPACE_ROOT/tests/fixtures/generate_kafka_side_topic_records.scala"
